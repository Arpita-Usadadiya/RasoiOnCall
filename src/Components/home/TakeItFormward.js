  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10 px-5">
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <video
            src="https://chefkart-strapi-media.s3.ap-south-1.amazonaws.com/mobile_video_be902dfffb.mp4"
            controls
            className="h-96 w-52 rounded-lg shadow-md"
          />
        </div>
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="flex justify-center lg:justify-start gap-4">
            ...
            >
              <img
                src="https://th.bing.com/th/id/OIP.todzFiCdppVXoPnT0HgwdAHaEK"
                alt="App Store"
                className="w-6 h-6 mr-2"
              />
              App Store
            ...
            >
              <img
                src="https://th.bing.com/th/id/OIP.Gu1NStDpNVmWisgSKKBzewHaEK"
                alt="Google Play"
                className="w-6 h-6 mr-2"
              />
              Google Play
