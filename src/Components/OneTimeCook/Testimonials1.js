  ...
  const testimonialsData = [
    {
      ...
      text: "Finding technology and support together is rare. Working with RasoiOnCall has given me not only steady income, but also confidence and long-term stability.",
      name: "Nitin Sharma",
    },
    {
      img: "https://dummyimage.com/300x300",
      text: "RasoiOnCall gave me the opportunity to turn my cooking skills into a professional career. Their team is always ready to guide and support me.",
      name: "Alpar Khamu",
    },
    {
      img: "https://dummyimage.com/305x305",
      text: "I was always searching for a platform that truly values human connection. RasoiOnCall proved my trust was right.",
      name: "Henry Latham",
    },
    {
      img: "https://dummyimage.com/302x302",
