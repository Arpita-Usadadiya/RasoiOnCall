...
const FaqSection = () => {
 ...
 const faqs = [
    ...
    },
    {
      ...
      answer: "How can I find out if this service is available in my area?",
    },
    {
    ...
    {
      question:
        "Will ChefKart provide the ingredients and utensils for the dishes?",
      answer:
    ...
    },
    {
      ...
      answer:
        "One chef will be provided. If required, additional chefs and/or helpers will be sent to ensure timely food preparation.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "You can reach out to us through the Help & Support section on the RasoiOnCall App. Our support team is available from 6:00 AM to 9:30 PM.",
    },
  ];
  ...
  return (
    <section className="bg-white py-8 sm:py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {/* Heading */}
        <h2 className="text-2xl sm:text-4xl md:text-5xl text-orange-400 font-bold text-center mb-6 sm:mb-10">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                text-left text-sm sm:text-lg font-medium text-gray-800"
              >
              ...
              <div
                className={`px-4 sm:px-6 text-sm sm:text-base text-gray-600 
