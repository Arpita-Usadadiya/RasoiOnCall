  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 bg-[#f1f1f1] w-full mt-20 lg:pl-10 lg:py-6 lg:mt-0">
        ...
        <h2 className=" title-font text-1xl text-black font-bold mt-4 ">ઉપર જાવ</h2>
        <button className="flex text-white mt-6 text-2xl bg-black border-0 py-2 px-6 rounded-lg">RasoiOnCall સાથે જોડાઓ</button> 
      </div>
    </div>
  </div>
</section>
